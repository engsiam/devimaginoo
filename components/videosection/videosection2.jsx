...
const divSections = [
  {
    ...
    bgVideo:
      "https://www.youtube.com/embed/Ap1tRdXX18Q?autoplay=1&mute=1&controls=0&showinfo=0&rel=0&modestbranding=1", // Embed YouTube URL
            ...
            <SwiperSlide className="owl-item" key={index}>
              {elm.bgVideo ? (
                ...
                >
                  ...
                  >
                    <iframe
                      src={`${elm.bgVideo}&autoplay=1&loop=1&playlist=Ap1tRdXX18Q`}
