...
const divSections = [
  {
    ...
    bgVideo:
      "https://www.youtube.com/embed/SUVL1C5kObk?autoplay=1&mute=1&controls=0&showinfo=0&rel=0&modestbranding=1", // Embed YouTube URL
            ...
            <SwiperSlide className="owl-item" key={index}>
              {elm.bgVideo ? (
                ...
                >
                  ...
                  >
                    <iframe
                      src={`${elm.bgVideo}&autoplay=1&loop=1&playlist=SUVL1C5kObk`}
